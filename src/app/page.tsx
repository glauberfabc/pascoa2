      ...
      <div className="relative">
        ...
        <div className="relative z-20">
          ...
          <section id="comece-agora" className="h-screen flex items-center justify-center md:justify-start px-8 md:px-24">
            <div className="max-w-md backdrop-blur-sm bg-white/20 p-8 rounded-3xl border border-white/50 shadow-2xl mix-blend-lighten text-center md:text-left">
              <motion.h1
              ...
              <motion.p
                ...
                className="text-xl font-medium text-slate-700 opacity-90 mb-4"
              >
          ...
          <section id="producao" className="h-screen flex items-center justify-center md:justify-end px-8 md:px-24">
            <div className="max-w-md backdrop-blur-sm bg-white/30 p-8 rounded-3xl border border-white/60 shadow-2xl mix-blend-lighten text-center md:text-right">
              <h2 className="text-3xl md:text-5xl font-bold mb-4" style={{ color: activeProduct.textColor }}>
          ...
          <section id="lucro" className="h-screen flex items-center justify-center md:justify-start px-8 md:px-24">
            <div className="max-w-md backdrop-blur-sm bg-white/30 p-8 rounded-3xl border border-white/60 shadow-2xl mix-blend-lighten text-center md:text-left">
              <h2 className="text-3xl md:text-5xl font-bold mb-4" style={{ color: activeProduct.textColor }}>
          ...
          <section className="h-screen flex items-center justify-center px-4 md:px-12">
            <div className="max-w-2xl text-center backdrop-blur-md bg-white/40 p-10 rounded-3xl border border-white/80 shadow-[0_0_50px_rgba(255,255,255,0.4)]">
              <h2 className="text-4xl md:text-6xl font-black mb-6" style={{ color: activeProduct.textColor }}>
                {activeProduct.section4.title}
              </h2>
              <p className="text-xl md:text-2xl text-slate-700 mb-8 max-w-xl mx-auto">
                {activeProduct.section4.description}
              </p>

              <div className="flex justify-center mt-8">
                <button className="px-10 py-4 rounded-full font-bold shadow-xl text-xl transition-transform hover:scale-105 bg-gradient-to-r from-pink-400 to-purple-500 text-white animate-pulse hover:animate-none hover:shadow-[0_0_30px_rgba(255,182,193,0.8)]">
                  Quero Começar Agora
                </button>
              </div>
            </div>
